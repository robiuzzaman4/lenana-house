...
import LargeImage from "@/components/pages/gallery/LargeImage";
import VideoGridSlider from "@/components/pages/gallery/VideoGridSlider";
import CTA from "@/components/pages/gallery/CTA";
